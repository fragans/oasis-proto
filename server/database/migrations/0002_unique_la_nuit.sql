...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journey_edges_journey_id_journeys_id_fk') THEN
...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journey_edges_source_node_id_journey_nodes_id_fk') THEN
...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journey_edges_target_node_id_journey_nodes_id_fk') THEN
...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journey_enrollments_journey_id_journeys_id_fk') THEN
...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journey_enrollments_contact_id_contacts_id_fk') THEN
...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journey_enrollments_current_node_id_journey_nodes_id_fk') THEN
...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journey_executions_enrollment_id_journey_enrollments_id_fk') THEN
...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journey_executions_node_id_journey_nodes_id_fk') THEN
...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journey_nodes_journey_id_journeys_id_fk') THEN
...
--> statement-breakpoint
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'journeys_segment_id_segments_id_fk') THEN
